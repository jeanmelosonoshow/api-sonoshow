  ...
  return {
    async read() {
      ...
      try {
        ...
        if (snapshot.schemaVersion !== 4 || !Array.isArray(snapshot.usuarios) || !Array.isArray(snapshot.vendas) ||
            !Array.isArray(snapshot.rejeitados?.usuarios) || !Array.isArray(snapshot.rejeitados?.vendas) ||
